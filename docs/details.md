...
Everything the [README](../README.md) leaves out: how it works, what was measured, the EAS update mode, the GitHub Action, the report server, the limitations, and how it was built.
