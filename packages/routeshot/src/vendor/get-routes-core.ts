// Adapted from expo/expo packages/expo-router/src/getRoutesCore.ts @ d461c0835dfdc9fad1688cf5c7c234a3c36b240e (MIT).
// Changes: (1) import paths repointed at the sibling vendored files (route-node, matchers, url);
// (2) mechanical strict-mode conformance for routeshot's tsconfig - `process.env.X` and
// `unstable_settings.X` rewritten as index access (noPropertyAccessFromIndexSignature) and optional
// properties widened with `| undefined` (exactOptionalPropertyTypes). The logic is verbatim.
...
import { shouldLinkExternally } from './url.js';
