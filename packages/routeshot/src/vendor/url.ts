// Adapted from expo/expo packages/expo-router/src/utils/url.ts @ d461c0835dfdc9fad1688cf5c7c234a3c36b240e (MIT).
// Changes: kept only the three helpers `getRoutesCore` needs; dropped the URL-parsing/decoding helpers.
